 ...
 * pessoa for maior que 18 e a pessoa sabe dirigir ou se a pessoa é arente do
 * dono da auto escola Escreva: fulato esta apto a dirigir Senao escreva: fulano
 * nao esta apto para dirigir 2 - Faça o menu: TURMAS DISPONIVEIS Pergunte a
 * quantidade de pessoas prestes a estudar para tirar a carteira Se a quantidade
 * de pessoas prestes a cursar for menor ou igual a 2 Escreva: Há vagas Senao
 * escreva: Não há vagas
 */
